...
const char *BACKEND_HOST = "http://192.168.0.103:4000"; // Adjust IP to backend
...
const uint16_t LDR_THRESHOLD = 250;           // Adjust after calibration (0-4095)
...
void buzz(uint16_t toneHz, uint32_t durationMs)
{
  // Use tone() function - compatible with all ESP32 core versions
